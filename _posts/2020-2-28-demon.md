...
Beginning with AdaGrad \citep{duchi2011adaptive}, the SGD recursion, per coordinate $i$ of $\theta$, becomes:
...
\begin{align*}
    \mathcal{E}^{g}_{t+1} &= \beta_1 \cdot \mathcal{E}^{g}_t + (1-\beta_1) \cdot g_t , \\
    \mathcal{E}^{g \circ g}_{t+1} &= \beta_2 \cdot \mathcal{E}^{g \circ g}_t + (1 - \beta_2) \cdot (g_t \circ g_t), \\
...
AdamW [^6] modifies the typical implementation of weight decay regularization in Adam, by decoupling the weight decay from the gradient update. In particular, L2 regularization in Adam is usually implemented with the below modification where $w_t$ is the rate of the weight decay at time t:
...
<img src="AdamResNetVGGTable.png" alt="" title="" width="680" height="150" />
...
<img src="AdamWideResNetCapsTable.png" alt="" title="" width="510" height="150" />
...
<img src="AdamLSTMVAETable.png" alt="" title="" width="560" height="150" />
...
<img src="AdamPlot.png" alt="" title="" width="1000" height="400" />
...
<img src="SGDMResNetTable.png" alt="" title="" width="430" height="110" />
...
<img src="SGDMVGGWideResNetTable.png" alt="" title="" width="710" height="150" />
...
<img src="SGDMLSTMVAETable.png" alt="" title="" width="650" height="150" />
...
<img src="SGDMPlot.png" alt="" title="" width="1000" height="410" />
...
[^1]: Goodfellow, I., Bengio, Y., Courville, A., and Bengio, Y.
Deep learning, volume 1. MIT Press, 2016.

[^2]: Duchi, J., Hazan, E., and Singer, Y. Adaptive subgradient
...
[^4]: Kingma, D. P. and Ba, J. Adam: A method for stochastic
optimization. arXiv preprint arXiv:1412.6980, 2014.

[^5]: Reddi, S. J., Kale, S., and Kumar, S. On the convergence
...
[^7]: Dozat, T. Incorporating nesterov momentum into adam.
ICLR Workshop, (1):20132016, 2016.
...
[^12]: Jain, P., Kakade, S. M., Kidambi, R., Netrapalli, P.,
and Sidford, A. Accelerating stochastic gradient descent for least squares regression. arXiv preprint arXiv:1704.08227, 2017.
...
[^16]: Zagoruyko, S. and Komodakis, N. Wide residual networks.
...
[^19]: Kingma, D. P. and Welling, M. Auto-encoding variational
bayes. arXiv preprint arXiv:1312.6114, 2015.
