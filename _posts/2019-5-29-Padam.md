...
The question revisited here is why take the exponent of v to be 0.5? What happens if we take the exponent of v to be 0? As it turns out, taking the exponent of v to be 0 actually results in SGDM! I think a natural way to capture both the initial quick learning of ADAM as well as the generalization of SGDM is to begin with an exponent of 0.5 and decay to some smaller exponent such as 0 using some decay rule.
